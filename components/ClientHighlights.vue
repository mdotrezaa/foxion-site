<template>
  <section class="relative text-white h-screen py-16">
    ...
    <div
      ...
      style="background-image: url('/images/testimonials/bg-testi.png')"
    />

    <!-- Overlay -->
    <div class="absolute inset-0 z-0 bg-[#184980E5]"/>

    <!-- Content -->
    <div class="relative z-10 max-w-[90rem] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      <!-- Left: Quotes -->
      <div>
        <h2 class="text-[36px] font-bold mb-6">Client & Company Highlights</h2>
        ...
        <div class="relative">
          ...
          <hr class="my-3 border-white/20 w-full" >
          <p class="text-[20px] text-white/80">HR Manager, Manufacturing Sector</p>
        </div>
      </div>
